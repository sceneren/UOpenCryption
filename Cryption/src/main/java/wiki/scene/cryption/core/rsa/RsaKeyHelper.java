package wiki.scene.cryption.core.rsa;
/**
...
import wiki.scene.cryption.utils.UUIDUtils;
...
public class RsaKeyHelper {
    ...
    public static synchronized KeyPass generateKeyPair(){
        ...
        //生成的密钥对编码成base64
        String publicKeyString = HexUtils.byteToHex(rsaPublicKey.getEncoded());
        String privateKeyString = HexUtils.byteToHex(rsaPrivateKey.getEncoded());
