package wiki.scene.cryption.core.dsa;
...
public class DSAKeyHelper {
    ...
    public static KeyPass genKeyPair(String seed){
        try{
            ...
            keyPass.setPublicKeyHex(HexUtils.byteToHex(publicKey.getEncoded()));
            keyPass.setPrivateKeyHex(HexUtils.byteToHex(privateKey.getEncoded()));
            return keyPass;
        }catch (Exception e){
            e.printStackTrace();
        }
